...
Add the JitPack resolver and depend on the `com.github.scala-hamsters` coordinates
(note the `com.github` group id, specific to JitPack):
...
libraryDependencies ++= Seq(
  "com.github.scala-hamsters" %% "hamsters" % "{release-version}"
)
----
