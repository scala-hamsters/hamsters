...
object release extends Module {
  def updateReadme(releaseVersion: String, documentationVersion: String) = T.command {
    ...
    write.over(readme, content
      ...
      .replaceAll(":documentation-version: ([0-9\\.]+)", s":release-version: $documentationVersion"))
  }

  def updateREPLscript(releaseVersion: String) = T.command {
